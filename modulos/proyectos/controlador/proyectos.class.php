...
}else if ( isset ($_GET["eliminar-proyecto"]) )
{
    ...
    header('Location: http://'.$_SERVER['SERVER_NAME'].':'.$_SERVER['SERVER_PORT'].'/modulos/simulacion/vistas/simulacion_wsn.php?err='.urlencode('url no econtrada'));
    //break;
}      
...
class proyectos
{
    ...
    {                
        ...
        if($proyecto == null)
        {
            ...
            header('Location: http://'.$_SERVER['SERVER_NAME'].':'.$_SERVER['SERVER_PORT'].'/modulos/proyectos/vistas/crear_proyecto_simulacion.php?err='.urlencode('Error al crear el Proyecto'));
            //break;
        }else{
            //ok proyecto creado
            header('Location: http://'.$_SERVER['SERVER_NAME'].':'.$_SERVER['SERVER_PORT'].'/modulos/proyectos/vistas/crear_proyecto_simulacion.php?ok='.urlencode('Proyecto creado correctamente'));
            //break;
        }
    ...
    public function validarNombreProyectoCreacion($unNombre)
    {
        ...
        header('Location: http://'.$_SERVER['SERVER_NAME'].':'.$_SERVER['SERVER_PORT'].'/modulos/proyectos/vistas/crear_proyecto_simulacion.php?err='.urlencode('El nombre de proyecto ya existe'));        
        }
    ...
    public function validarNombreProyectoModificacion($unNombre,$proyecto_id)
    {
        ...
        if( ( ($existeNombreProyecto->id) === ($proyecto_id) ) ){
            ...
            header('Location: http://'.$_SERVER['SERVER_NAME'].':'.$_SERVER['SERVER_PORT'].'/modulos/proyectos/vistas/modificar_proyecto_simulacion.php?err='.urlencode('El nombre de proyecto ya existe'));            
        }
    }
    ...
    public function modificarProyecto($proyecto_id,$nombre,$descripcion)
    {
        ...
        if($resul == null)
        {
            ...
            header('Location: http://'.$_SERVER['SERVER_NAME'].':'.$_SERVER['SERVER_PORT'].'/modulos/proyectos/vistas/modificar_proyecto_simulacion.php?err='.urlencode('Error al modificar el Proyecto'));
        }else{
            //ok proyecto creado
            header('Location: http://'.$_SERVER['SERVER_NAME'].':'.$_SERVER['SERVER_PORT'].'/modulos/proyectos/vistas/modificar_proyecto_simulacion.php?ok='.urlencode('Proyecto modificado correctamente'));
        }
    ...
    public function eliminarProyecto($proyecto_id)
    {
        ...
        {
            //ok proyecto creado
            header('Location: http://'.$_SERVER['SERVER_NAME'].':'.$_SERVER['SERVER_PORT'].'/modulos/proyectos/vistas/eliminar_proyecto_simulacion.php?ok='.urlencode('Proyecto eliminado correctamente'));
            
        }else{
            //error interno al eliminar el proyecto
            header('Location: http://'.$_SERVER['SERVER_NAME'].':'.$_SERVER['SERVER_PORT'].'/modulos/proyectos/vistas/eliminar_proyecto_simulacion.php?err='.urlencode('Error al modificar el Proyecto'));
        }
    }
