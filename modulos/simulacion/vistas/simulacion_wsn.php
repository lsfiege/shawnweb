...
<header id="menu_cabecera">
    <h1 class="titulo_home">
        <a class="link_home"
           href=" <?php echo 'http://'.$_SERVER['SERVER_NAME'].':'.$_SERVER['SERVER_PORT'].'/modulos/simulacion/vistas/simulacion_wsn.php' ?> ">
            ShawnWEB
        </a>
        <span> Simulación de WSN Basada en la Web</span>
    </h1>
        ...
        <footer>
            <div class="btn_mover_tab">
                <input type="button" value="Siguiente" name="siguiente"
                       onClick="activar_tab('panel_control', 'tab_2'); return false;"/>
            </div>
        </footer>
    </section>
</article>
...
<article id="panel_control" class="mostrar_ocultar">
    <section id="control">
        ...
        <footer>
            <div class="btn_mover_tab">
                <input type="button" value="Anterior" name="anterior"
                       onClick="activar_tab('panel_desarrollo', 'tab_1'); return false;"/>
                <input type="button" value="Siguiente" name="siguiente"
                       onClick="activar_tab('salida_compilacion', 'tab_3'); return false;"/>
            </div>
        </footer>
    </section>
</article>
...
<article id="salida_compilacion" class="mostrar_ocultar">
    ...
    <footer>
        <div class="btn_mover_tab">
            <input type="button" value="Anterior" name="crear_proyecto"
                   onClick="activar_tab('panel_control', 'tab_2'); return false;"/>
            <input type="button" value="Siguiente" name="siguiente"
                   onClick="activar_tab('salida_ejecucion', 'tab_4'); return false;"/>
        </div>
    </footer>
</article>
