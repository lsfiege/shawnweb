...
<html lang="es">
	...
	<body>  
            <header id="menu_cabecera"> 
                <h1 class="titulo_home"><a class="link_home" href=" <?php echo 'http://'.$_SERVER['SERVER_NAME'].':'.$_SERVER['SERVER_PORT'].'/modulos/simulacion/vistas/simulacion_wsn.php'?> ">ShawnWEB</a><span> Simulaci&oacute;n de WSN Basada en la Web</span></h1>
                <nav>
                    <ul>
                    ...
                    <header>    
                        ...
                        <div class="botones_accion">
                            ...
                            <input type="button" value="Ejecutar" name="ejecutar" onClick="ejecutar_proyecto(); return false;"/>
                                ...
                                <a id="link_salida_pdf" href="http://<?php echo $_SERVER['SERVER_NAME'].':'.$_SERVER['SERVER_PORT'];?>/modulos/simulacion/controlador/simulacion.class.php" target="_blank">Visualizar</a>                                
                            </form>
                        </div>
                    </header>
